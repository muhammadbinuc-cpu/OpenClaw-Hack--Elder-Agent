    ...
    <section style={{
      ...
      <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 items-center px-8 md:px-12 py-20 md:py-28 max-w-6xl" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            <span
              ...
              style={{
                ...
                boxShadow: '0 0 22px rgba(245,196,81,0.12)',
              }}
            >
              <Trophy size={12} strokeWidth={2.4} />
              1st Place · OpenClaw Hackathon 2026
            </span>
          ...
          >
            A photo from Meta Ray-Ban glasses becomes a verified, on-chain medication
            refill — read by vision AI, routed through autonomous agents, approved by you.
          </motion.p>
